NZ.config = {
     ...
     * NZ metadata API call to center and zoom the map. The following
    ...
    siteName            : "My NZ Instance",
    siteDescription     : "An OpenTripPlanner deployment.",
    logoGraphic         : 'images/NZ_logo_darkbg_40px.png',
    // bikeshareName    : "",
   ...
   /* modules : [
        {
            id : 'planner',
            className : 'NZ.modules.multimodal.MultimodalPlannerModule',
            defaultBaseLayer : 'MapQuest OSM',
            isDefault: true
        },
        {
            id : 'analyst',
            className : 'NZ.modules.analyst.AnalystModule',
        }
    ],*/
