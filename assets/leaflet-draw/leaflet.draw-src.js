 ...
 */
    L.drawVersion = "0.2.3-dev", L.drawLocal = { draw: { toolbar: { actions: { title: "取消绘制", text: "取消" }, buttons: { polyline: "画线", polygon: "画面", rectangle: "画矩形", circle: "画圆", marker: "画标注" } }, handlers: { circle: { tooltip: { start: "点击并拖动画圆" } }, marker: { tooltip: { start: "点击地图放置一个标注" } }, polygon: { tooltip: { start: "点击开始绘制多边形", cont: "点击开始绘制", end: "点击开始点结束绘制" } }, polyline: { error: "<strong>错误:</strong> 图形不闭合!", tooltip: { start: "点击开始画线.", cont: "点击继续画线.", end: "点击最后一个点结束." } }, rectangle: { tooltip: { start: "点击并拖动开始画矩形" } }, simpleshape: { tooltip: { end: "释放鼠标结束绘制." } } } }, edit: { toolbar: { actions: { save: { title: "保存改动.", text: "保存" }, cancel: { title: "取消绘制, 所有改动失效.", text: "取消" } }, buttons: { edit: "编辑图层.", editDisabled: "没有可编辑图层.", remove: "删除图层.", removeDisabled: "没有可删除图层." } }, handlers: { edit: { tooltip: { text: "拖动边或标注开始编辑.", subtext: "点击取消返回改动." } }, remove: { tooltip: { text: "点击一个要素以移除" } } } } },
    L.Draw = {};
